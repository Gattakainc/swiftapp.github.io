...
!function e(t,n,i){function a(o,s){if(!n[o]){if(!t[o]){var c="function"==typeof require&&require;if(!s&&c)return c(o,!0);if(r)return r(o,!0);var d=new Error("Cannot find module '"+o+"'");throw d.code="MODULE_NOT_FOUND",d}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return a(n?n:e)},l,l.exports,e,t,n,i)}return n[o].exports}for(var r="function"==typeof require&&require,o=0;o<i.length;o++)a(i[o]);return a}({1:[function(e,t,n){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}var a=e("inline-retina"),r=i(a);!function(e,t){function n(e){var t=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return t.test(e)}t("body").addClass("js-loaded"),(0,r["default"])();for(var i,a,o=["icon-1","icon-2","icon-3","icon-4","icon-5","icon-6","icon-7"],s=0;s<o.length;s++)i=o[s],t("#"+i).length>0&&(a=new Vivus(i,{type:"delayed",duration:200,delay:50,pathTimingFunction:Vivus.EASE}),a.init());t("#submit-btn").click(function(){var e=t("#name").val(),i=t("#email").val(),a=t("#phone").val(),r=t("#submit-btn"),o=t("#form-warning"),s=t("#form-success"),c=t("#demo-success"),d=t("#demo-standard");return s.addClass("hidden"),c.addClass("hidden"),""!==e&&""!==i&&""!==a&&n(i)?(o.addClass("hidden"),r.attr("disabled","disabled"),void t.ajax({type:"POST",url:"https://script.google.com/macros/s/AKfycbyNj5lxu7NeCD-21fxe6Gq1ppbIIffJCTyRmMPsOkeKJ5qsGRM/exec",data:{name:e,email:i,phone:a},success:function(){r.removeAttr("disabled","disabled"),s.removeClass("hidden"),c.removeClass("hidden"),d.addClass("hidden")}})):void o.removeClass("hidden")});t(".aws-access-form");t(".aws-access-form").submit(function(e){var n=t(this),i=(n.find("#company-name, #aws-region, #aws-access-key-id, #secret-access-key"),n.serialize());t.ajax({url:"https://script.google.com/macros/s/AKfycbxtlyoPpt0rL0oXxW7AthVbM-W9Gx15rTCRcnL9vDOdHEQ6JAmF/exec",type:"POST",data:i,success:function(e){t("#aws-form-container").html("<h3>We have received your credentials and will reach out to you shortly!</h3>")}}),e.preventDefault()}),e.intercomSettings={app_id:"yvhm7h1r"},function(){var t=e,n=t.Intercom;if("function"==typeof n)n("reattach_activator"),n("update",intercomSettings);else{var i=function(){var e=a.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://widget.intercom.io/widget/yvhm7h1r";var t=a.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)},a=document,r=function o(){o.c(arguments)};r.q=[],r.c=function(e){r.q.push(e)},t.Intercom=r,t.attachEvent?t.attachEvent("onload",i):t.addEventListener("load",i,!1)}}();var c=new WOW({boxClass:"wow",animateClass:"animated",offset:100,mobile:!0,live:!0});c.init()}(window,window.jQuery),function(e,t,n,i,a,r,o){e.GoogleAnalyticsObject=a,e[a]=e[a]||function(){(e[a].q=e[a].q||[]).push(arguments)},e[a].l=1*new Date,r=t.createElement(n),o=t.getElementsByTagName(n)[0],r.async=1,r.src=i,o.parentNode.insertBefore(r,o)}(window,document,"script","https://www.google-analytics.com/analytics.js","ga"),ga("create","UA-97232498-1","auto"),ga("send","pageview")},{"inline-retina":2}],2:[function(e,t,n){t.exports=function(){"use strict";var e="(-webkit-min-device-pixel-ratio: 1.5),(min--moz-device-pixel-ratio: 1.5),(-o-min-device-pixel-ratio: 3/2),(min-device-pixel-ratio: 1.5),(min-resolution: 144dpi),(min-resolution: 1.5dppx)";if(window.devicePixelRatio>1||window.matchMedia&&window.matchMedia(e).matches)for(var t=document.getElementsByClassName("retina"),n=0;n<t.length;n++){var i,a=t[n].getAttribute("src"),r=t[n].clientWidth,o=a.split(".").pop();"png"===o?i=a.replace(".png","@2x.png"):"jpg"===o?i=a.replace(".jpg","@2x.jpg"):"jpeg"===o&&(i=a.replace(".jpeg","@2x.jpeg")),t[n].width=r,t[n].src=i}}},{}]},{},[1]);
